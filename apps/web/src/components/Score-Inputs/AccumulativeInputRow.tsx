...
export const AccumulativeInputRow = ({ score, onUpdateDetails, disableExclusives }: AccumulativeInputRowProps) => (
    <div className="flex flex-1 items-center gap-2">
        <input
            ...
            onChange={(e) => onUpdateDetails({ pointsAdded: parseInt(e.target.value.replace(/\D/g, "")) || 0 })}
        />
        <button
